...
public class ElderDebrisOreBlock extends NompesLegendaryWeaponsModElements.ModElement {
	@ObjectHolder("nompes_legendary_weapons:elder_debris_ore")
	public static final Block block = null;

	public ElderDebrisOreBlock(NompesLegendaryWeaponsModElements instance) {
		super(instance, 7);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.ANCIENT_DEBRIS).hardnessAndResistance(100f, 1200f).setLightLevel(s -> 0)
					.harvestLevel(4).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("elder_debris_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("nompes_legendary_weapons:elder_debris_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("elder_debris_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nompes_legendary_weapons:elder_debris_ore"),
					configuredFeature);
		}
	}
