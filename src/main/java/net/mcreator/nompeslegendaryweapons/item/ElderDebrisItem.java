...
public class ElderDebrisItem extends NompesLegendaryWeaponsModElements.ModElement {
	@ObjectHolder("nompes_legendary_weapons:elder_debris")
	public static final Item block = null;

	public ElderDebrisItem(NompesLegendaryWeaponsModElements instance) {
		super(instance, 6);
	}
