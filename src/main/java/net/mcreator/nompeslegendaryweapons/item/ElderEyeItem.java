...
public class ElderEyeItem extends NompesLegendaryWeaponsModElements.ModElement {
	@ObjectHolder("nompes_legendary_weapons:elder_eye")
	public static final Item block = null;

	public ElderEyeItem(NompesLegendaryWeaponsModElements instance) {
		super(instance, 5);
	}
