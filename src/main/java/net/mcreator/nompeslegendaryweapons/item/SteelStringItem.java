...
public class SteelStringItem extends NompesLegendaryWeaponsModElements.ModElement {
	@ObjectHolder("nompes_legendary_weapons:steel_string")
	public static final Item block = null;

	public SteelStringItem(NompesLegendaryWeaponsModElements instance) {
		super(instance, 12);
	}
